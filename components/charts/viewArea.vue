...
<template>
    <div>
            ...
            <div class="text-center">
                <div role="status">
                    <svg aria-hidden="true"
                         class="inline w-8 h-8 text-orange-200 animate-spin dark:text-gray-600 fill-orange-600"
        ...
        <template v-else-if="valoresArray && valoresArray.length > 0">
            <area-optionchart  :series="valoresArray" :name="Datos"
                             :fecha="valorFecha" :y="props.y" :y2="props.y2"></area-optionchart>
