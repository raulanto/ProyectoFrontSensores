...
<template>
    <div class="grid grid-cols-5 grid-rows-3 gap-4">
        <div>
            <vuekipichart :name="'Media'" :valor="media"/>
        </div>
        <div class="col-span-4 row-span-3">
            <view-area :etapa="props.etapa" :y2="props.valorMin" :y="props.valorMax" :fk="props.fk" :name="props.name"/>
        </div>
        <div class="row-start-2">
            <vuekipichart :name="'Valor Maximo'" :valor="valorMaximo"/>
        </div>
        <div class="row-start-3">
            <vuekipichart :name="'Valor Minimo'" :valor="valorMinimo"/>
        </div>
    </div>
</template>
